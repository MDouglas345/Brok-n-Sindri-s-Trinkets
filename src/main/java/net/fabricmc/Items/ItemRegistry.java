...
public class ItemRegistry {
    ...
    public static void register(){
        Registry.register(Registry.ITEM, new Identifier(BNSCore.ModID, "dwarven_forge"), new BlockItem(BNSCore.DWARVEN_FORGE_BLOCK, new FabricItemSettings().maxCount(1).group(ItemGroupRegistry.DWARVEN_BLOCKS)));
